...
public class ReadQRCode : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (QRButton.clicked)
        {
            ...
            grabQR = true;
            //Debug.Log(resulttext.text = result.BarcodeFormat.ToString());
    ...
    {
        //Debug.Log(resulttext.text = "PostRenderOn");
        if (grabQR==true)
        {
            ...
            try
            {
                ...
                if (result != null)
                {
                    Debug.Log(resulttext.text = "true");

                    Debug.Log("QR Text:" + result.Text);
                    Debug.Log(resulttext.text = result.Text);
                    Debug.Log(resulttext.text = result.BarcodeFormat.ToString());
                }
            }
            catch (Exception e)
            {
                Debug.Log(resulttext.text = "trueEEE");
